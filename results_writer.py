...
recorded:
  ...
  best_*        per-metric maximum over epochs. This is ORACLE test selection
                and is the protocol every published baseline in
                analysis/tables/published_baselines.csv used, so it is the
